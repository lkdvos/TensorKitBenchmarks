...
# ----------
repetitions = 5
maxdims = Dict("SU2" => typemax(Int), "U1" => 8000, "Trivial" => 2000)
...
# Argument parser
# ---------------
const filename_in = joinpath(@__DIR__, "heisenberg_spaces.toml")
const filename_out = joinpath(@__DIR__, "heisenberg_results")
