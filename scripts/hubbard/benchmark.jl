...
# ----------
repetitions = 5
maxdims = Dict("fZ2xSU2xSU2" => typemax(Int), "fZ2xU1xSU2" => typemax(Int), "fZ2xU1xU1" => typemax(Int), "fZ2" => 8000)
...
# Argument parser
# ---------------
const filename_in = joinpath(@__DIR__, "hubbard_spaces.toml")
const filename_out = joinpath(@__DIR__, "hubbard_results")
